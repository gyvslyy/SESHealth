...
public class MainActivity extends AppCompatActivity {
    ...
    private enum MenuStates {
        PATIENT_INFO, DATA_PACKET, HEARTRATE, RECORD_VIDEO, SEND_FILE, NAVIGATION_MAP, DOCTOR
    }
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.nav_map:
                                ...
                                break;
                            case R.id.nav_doc:
                                if (currentState != MenuStates.DOCTOR) {
                                    ChangeFragment(new DoctorFragment());
                                    currentState = MenuStates.DOCTOR;
                                }
                                break;
                            case R.id.sign_out:
