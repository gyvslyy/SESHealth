...
public class ViewHeartRateActivity extends AppCompatActivity {

    private Toolbar mToolbar;
    private TextView viewHrTv;
    ...
    private static final String TAG = "ViewHeartRateActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewHrTv = findViewById(R.id.viewHRTv);

        mToolbar = (Toolbar)findViewById(R.id.view_HR_toolbar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Patient Heartbeat");
...
//        Log.d(TAG, "onCreate: 647");
    ...
    private void getData(DataSnapshot dataSnapshot) {
        int i = 1;
        for(DataSnapshot ds : dataSnapshot.child(ID).child("Heartbeat").getChildren()) {
        ...
        if(value1==0&&value2==0&&value3==0&&value4==0&&value5==0&&value6==0&&value7==0){
            viewHrTv.setText("No heartbeat records right now");
        }else{
            viewHrTv.setText(" ");
        }
    }
